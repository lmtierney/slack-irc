...
class Bot {
  ...
  sendToSlack(author, channel, text) {
    ...
    if (slackChannelName) {
      ...
      const replacedText = replaceUsernames(currentChannelUsernames, NICK_REGEX, text);
